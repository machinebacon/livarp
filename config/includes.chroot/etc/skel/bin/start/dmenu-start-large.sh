...
# session list
# ------------
choice=`echo -e "01: vtwm\n02: dwm\n03: ratpoison\n04: wmfs\n05: dwm_reloaded\n06: spectrwm\n07: evilwm\n08: openbox\n09: pekwm\n10: awesome\n11: fluxbox\n12: scripts de lancement\n13: éteindre" | dmenu -fn "-*-terminus-medium-*-*-*-16-*-*-*-*-*-*-*" -nb "#222222" -nf "#7D7D7D" -sb "#005885" -sf "#D7D7D7" -p "choisir ou éditer une session:" | cut -d ':' -f 1`
# session launchers
# -----------------
case $choice in
    ...
    12) geany -s $HOME/bin/start/*_start.sh $HOME/.config/openbox/autostart $HOME/.xinitrc; $HOME/bin/start/dmenu-start.sh ;;
