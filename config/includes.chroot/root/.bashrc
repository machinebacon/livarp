...
alias mkdir='mkdir -p'
# packages -------------------------------------------------------------
alias debup='apt-get update && apt-get dist-upgrade && apt-get clean'
alias debsh='apt-cache search'
alias debvs='apt-cache policy'
alias debcl='apt-get clean'
alias debin='apt-get --no-install-recommends install'
alias debrm='apt-get autoremove --purge'
alias debgui='synaptic'
# quit, exit & reboot --------------------------------------------------
alias :q='exit'
alias oust='echo "bye $USER..."; sleep 2s && shutdown -h now'
alias comeback='echo "be back right now..."; sleep 2s && shutdown -r now'
# bash cfg -------------------------------------------------------------
alias bcfg='vim /root/.bashrc'
alias brld='source /root/.bashrc'
# end of alias #########################################################
...
if [ "$color_prompt" = yes ]; then
    ...
    PS1='${debian_chroot:+($debian_chroot)} \e[0;31m\u\e[m@\e[0;36m\h\e[m \e[01;34m\w\e[m\n\e[0;31m #\e[m '
